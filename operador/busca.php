...
<html lang="pt-br">
    ...
    <body>
        <div class="estrutura">
            ...
            <div class="conteudo">
                <div class="subtitulo">
                    Operadores do Sistema :: Consultar/Alterar
                </div>
                ...
                $query = "SELECT user.*, userprofile.description as profile from {$statement} LIMIT {$startpoint} , {$per_page}";
                ...
                if ($nRows != 0) {
                    ...
                    foreach ($result as $temp) {
                        ...
                        $sit = ($temp->isOut === 'S') ? '<b>Inativo</b>' : 'Ativo';
                        echo "<td>\n";
                        echo $sit . "\n";
                        echo "</td>\n";
                        ...
                        echo "<td>\n";
                        echo "<a href=\"formAlterar.php?id=" . $temp->id . "\">Alterar</a>\n";
                        echo "</td>\n";
                ...
                <div class="menuTopo">
                    <ul class="submenu">
                        ...
                        <li><a href="formCadastro.php">Novo Cadastro</a></li>
