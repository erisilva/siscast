...
<html lang="pt-br">
    ...
    <body>
        <div class="estrutura">
            ...
            <div class="conteudo">
                <div class="subtitulo">
                    Raças :: Configurar um novo cadastro
                </div>
                
                <div class="atencao alinha">
                    Raça que será incluída na listagem do pedido.
                </div>                
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    TDBConnection::prepareQuery("insert into racas values ( null, :descricao)");
                ...
                <form name="formExec" id="formExec" method="post"
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="descricao" id="descricao"
                               maxlength="180" size="30" required autofocus
                               value=""><br><br>
