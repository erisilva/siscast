    ...
    */
    ...
    public function query()
    {
        return Pedido::query()->select( 'pedidos.codigo', 
                                        ...
                                        DB::raw('COALESCE(DATE_FORMAT(pedidos.agendaQuando, \'%d/%m/%Y\'), "") AS data_agenda'),
                                        ...
                                        DB::raw('COALESCE(DATE_FORMAT(pedidos.primeiraTentativaQuando, \'%d/%m/%Y\'), "") AS primeiraTentativaQuando'),
                                        'pedidos.primeiraTentativaHora',
                                        'pedidos.segundaTentativa',
                                        DB::raw('COALESCE(DATE_FORMAT(pedidos.segundaTentativaQuando, \'%d/%m/%Y\'), "") AS segundaTentativaQuando'),
                                        'pedidos.segundaTentativaHora',
                                        'pedidos.nota',
                                        DB::raw('COALESCE(DATE_FORMAT(pedidos.agendaQuando, \'%d/%m/%Y\'), "") AS data_agenda2'),
                                        'pedidos.agendaTurno',
